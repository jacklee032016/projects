...
*/
EXP_FUNC void STDCALL SHA512_Init(SHA512_CTX *ctx)
{
...
*/
EXP_FUNC void STDCALL SHA512_Update(SHA512_CTX *ctx, const uint8_t * msg, int len)
{
...
*/
EXP_FUNC void STDCALL SHA512_Final(uint8_t *digest, SHA512_CTX *ctx)
{
    int i;
    size_t paddingSize;
    uint64_t totalSize;
   ...
   ctx->w_buf.w[15] = be64toh(totalSize);
    ...
    if (digest != NULL)
       memcpy(digest, ctx->h_dig.digest, HASH_MD_LENGTH_SHA512);
 }
