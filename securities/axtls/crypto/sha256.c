 ...
 */
EXP_FUNC void STDCALL SHA256_Init(SHA256_CTX *ctx)
{
    ctx->total[0] = 0;
    ctx->total[1] = 0;
 ...
 */
EXP_FUNC void STDCALL SHA256_Update(SHA256_CTX *ctx, const uint8_t * msg, int len)
{
 ...
 */
EXP_FUNC void STDCALL SHA256_Final(uint8_t *digest, SHA256_CTX *ctx)
{
    uint32_t last, padn;
    uint32_t high, low;
    uint8_t msglen[8];
