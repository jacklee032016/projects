...
#define SSL_DISPLAY_STATES				0x00100000
#define SSL_DISPLAY_BYTES				0x00200000
#define SSL_DISPLAY_CERTS				0x00400000
#define SSL_DISPLAY_RSA					0x00800000
#define SSL_CONNECT_IN_PARTS			0x01000000

#define	SSL_DISPLAY_ALL		(SSL_DISPLAY_STATES|SSL_DISPLAY_BYTES|SSL_DISPLAY_CERTS|SSL_DISPLAY_RSA)
...
typedef	enum{
	SSL_OBJ_X509_CERT			= 1,
	SSL_OBJ_X509_CACERT		= 2,
	SSL_OBJ_RSA_KEY			= 3,
	SSL_OBJ_PKCS8				= 4,/* private key*/
	SSL_OBJ_PKCS12				= 5/* private key*/
}SSL_OBJ_T;

#define	OBJ_NAME(objType)		(##objType)
/**
 ...
 * - < 0 if an error.
 * @see tls.h for the error code list.
 ...
 * - CST_AES128_CBC_SHA (0x2f)
 * - CST_AES256_CBC_SHA (0x35)
 * - CST_RC4_128_SHA (0x05)
 * - CST_RC4_128_MD5 (0x04)
 */
