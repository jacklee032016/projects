...
#ifndef __WCC_INTEGER_H__
#define __WCC_INTEGER_H__

/* may optionally use fast math instead, not yet supported on all platforms and may not be faster on all */
#include <wccTypes.h>       /* will set MP_xxBIT if not default */
#ifdef USE_FAST_MATH
    #include <tfm.h>
#else
