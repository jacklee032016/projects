...
/**
 *        Retrieve a bitstring ASN.1 tag without unused bits and its
 *              value.
...
/**
 *        Retrieve an AlgorithmIdentifier ASN.1 sequence with NULL or no
 *              params.
 *              Updates the pointer to immediately behind the full
 *              AlgorithmIdentifier.
 *
...
/**
 *        Find a specific named_data entry in a sequence or list based on
 *              the OID.
 *
