...
/**
 *            Translate an ASN.1 OID into its numeric representation
...
/**
 *           Translate an X.509 attribute type OID into the short name
...
/**
 *           Translate PKCS#12 PBE algorithm OID into md_type and
 *                 cipher_type
 *
 * \param oid           OID to use
 * \param md_alg        place to store message digest algorithm
