...
/**
 *           Generic wrapper to perform a PKCS#1 encryption using the
...
/**
 *           Generic wrapper to perform a PKCS#1 decryption using the
...
/**
 *           Generic wrapper to perform a PKCS#1 signature using the
...
/**
 *           Generic wrapper to perform a PKCS#1 verification using the
