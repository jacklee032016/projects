 ...
 *
 * \return          a statically allocated array of digests, the last entry is 0.
 */
 ...
 * \return          The message digest information associated with md_name or NULL if not found.
 */
const mbedtls_md_info_t *mbedtls_md_info_from_string( const char *md_name );

/**
 *            Returns the message digest information associated with the
 *                  given digest type.
 *
